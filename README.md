...
Temporal structural confidence — whether the local signal state is temporally coherent and structurally stable.
Current-state predictive utility — how much each source contributes under the present fusion state.
Coalition-level complementarity — whether a source provides non-redundant information when combined with other sources.
